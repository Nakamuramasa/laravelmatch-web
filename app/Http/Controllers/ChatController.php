...
class ChatController extends Controller
{
    public static function show(Request $request)
    {
        ...
        if($chat_room_id->isEmpty()){
            ...
            ChatRoomUser::create(['chat_room_id' => $chat_room_id, 'user_id' => Auth::id()]);
            ChatRoomUser::create(['chat_room_id' => $chat_room_id, 'user_id' => $matching_user_id]);
        }
        ...
        ->orderby('created_at')
        ->get();
        return view('chat.show', ['chat_room_id'=>$chat_room_id, 'chat_room_user'=>$chat_room_user, 'chat_messages'=>$chat_messages, 'chat_room_user_name'=>$chat_room_user_name]);
    }

    public static function chat(Request $request, ChatMessage $chat)
    {
