...
<div class="topPage">
    <nav class="nav">
        <ul>
            <li class="personIcon"><a href="{{ route('users.show', ['user' => Auth::id()]) }}"><i class="fas fa-user fa-2x"></i></a></li>
            <li class="appIcon"><a href="{{ route('home') }}"><img src="/storage/images/laravel-match-icon.png"></a></li>
